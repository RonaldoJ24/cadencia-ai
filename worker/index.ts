...
import { AdaptationWorkflow } from './workflows/adaptation.ts';

export { AdaptationWorkflow };
...
function routeBindings(env: HandlerEnv): Readonly<Record<string, string>> {
  ...
  return Object.freeze({
    ...
    CADENCIA_ALLOW_TEST_IDENTITY: read('CADENCIA_ALLOW_TEST_IDENTITY'),
    ...
    CADENCIA_ACCESS_TEAM_DOMAIN: read('CADENCIA_ACCESS_TEAM_DOMAIN'),
    CADENCIA_ACCESS_AUD: read('CADENCIA_ACCESS_AUD'),
  });
}
